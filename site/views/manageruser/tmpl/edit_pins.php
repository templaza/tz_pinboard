    ...
    <div id="tz_pins_edit_content">
        <form action="index.php?option=com_tz_pinboard" method="post">
            ...
            <div class="tz_pins_edit_content_1">
                ...
                <input class="tz_pins_input"  type="text" name="edittitle" value= "<?php echo $this->editpin->content_title;?>" />
            </div>
            <div class="tz_pins_edit_content_1">
                <label><?php echo JText::_('COM_TZ_PINBOARD_MANAGERUSER_PINS_ALIAS'); ?></label>
                <input class="tz_pins_input"  type="text" name="aliaspins" value= "<?php echo $this->editpin->alias_content;?>" />
            ...
            ?>
                <div class="tz_pins_edit_content_1">
                    ...
                    <input class="tz_pins_input" disabled="false"  type="text" name="editweb" value= "<?php echo $this->editpin->url;?>" />
                </div>
            <?php
            }
            ?>
            ...
            <div class="tz_pins_edit_content_2">
                ...
                <textarea name="textreaname" id="tz_pins_edit_textra"  style="width: 370px; height: 110px;" ><?php echo strip_tags($this->editpin->content_introtext) ;?></textarea>
            </div>
            <div class="tz_pins_edit_content_2">
                ...
                ?>
                <p>
                    <img  data-option-id-img="<?php echo $this->editpin->content_id; ?>"  class="dasd" src="<?php echo JUri::root().'/'.$img_type_replaca ?>" ">
                </p>
                <div class="cler"></div>
            </div>
