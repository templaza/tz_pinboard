...
<form action="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=users');?>" method="post" name="adminForm" id="adminForm">
...
<!--				</th>-->
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if ($canEdit) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&task=user.edit&id='.(int) $item->id); ?>" title="<?php echo JText::sprintf('COM_USERS_EDIT_USER', $this->escape($item->name)); ?>">
