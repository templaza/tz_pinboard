...
class TZ_PinboardHelper
{
	...
	public static function addSubmenu($vName)
	{
        ...
        JHtmlSidebar::addEntry(
			JText::_('COM_TZ_PINBOARD_SUBMENU_CATEGORIES'),
			'index.php?option=com_tz_pinboard&view=categories',
			$vName == 'categories');
        JHtmlSidebar::addEntry(
            JText::_('COM_TZ_PINBOARD_SUBMENU_BOARDS'),
            'index.php?option=com_tz_pinboard&view=board',
            $vName == 'board');
		JHtmlSidebar::addEntry(
			JText::_('COM_TZ_PINBOARD_SUBMENU_ARTICLES'),
			'index.php?option=com_tz_pinboard&view=articles',
			$vName == 'articles'
		);
//		JHtmlSidebar::addEntry(
//			JText::_('COM_TZ_PINBOARD_SUBMENU_FEATURED_ARTICLES'),
//			'index.php?option=com_tz_pinboard&view=featured',
//			$vName == 'featured'
//		);
        JHtmlSidebar::addEntry(
       			JText::_('COM_TZ_PINBOARD_SUBMENU_COMMNET'),
       			'index.php?option=com_tz_pinboard&view=comment',
       			$vName == 'comment'
       		);
        JHtmlSidebar::addEntry(
            JText::_('COM_TZ_PINBOARD_SUBMENU_TAGS'),
            'index.php?option=com_tz_pinboard&view=tags',
            $vName == 'tags');
        JHtmlSidebar::addEntry(
            JText::_('COM_TZ_PINBOARD_SUBMENU_USERS'),
            'index.php?option=com_tz_pinboard&view=users',
            $vName == 'users');
	}
