 ...
 */
class TZ_PinboardModelCategories extends JModelList
{
    /**
     * Constructor.
     *
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $extension = $app->getUserStateFromRequest('com_tz_pinboard.categories.filter.extension', 'extension', 'com_tz_pinboard', 'cmd');
    ...
    function getListQuery()
    {
        ...
        $query->join('LEFT', '#__tz_pinboard_categories AS c ON c.catid = a.id');
        $query->join('LEFT', '#__tz_pinboard_fields_group AS fg ON c.groupid = fg.id');
    ...
    public function getGroupQuery($catid)
    {
        ...
        $query->select('fg.*');
        $query->from('#__tz_pinboard_fields_group AS fg');
        $query->join('LEFT', '#__tz_pinboard_categories AS c ON c.groupid = fg.id');
