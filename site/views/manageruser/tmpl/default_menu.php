...
<div id="tz_pinboard_warp_menu">
            <ul>
                <li <?php if(JRequest::getString('task')=='board' || JRequest::getString('task')=="" ){ echo"class='active'";} ?> >
                ...
                <li <?php if(JRequest::getString('task')=='pins'){ echo"class='active'";} ?> >
                ...
                <li <?php if(JRequest::getString('task')=='likes'){ echo"class='active'";} ?> >
                ...
                <li <?php if(JRequest::getString('task')=='followers'){ echo"class='active'";} ?> >
                ...
                <li <?php if(JRequest::getString('task')=='following'){ echo"class='active'";} ?> >
