...
<form action="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=users'); ?>" method="post" name="adminForm"
      id="adminForm">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    <input type="text" name="filter_search" id="filter_search"
                           placeholder="<?php echo JText::_('COM_USERS_SEARCH_USERS'); ?>"
                ...
                <div class="btn-group pull-left">
                    ...
                    <button type="button" class="btn tip hasTooltip"
                            ...
                            data-original-title="<?php echo JText::_('JSEARCH_RESET'); ?>"><i class="icon-remove"></i>
                    </button>
                </div>
            </div>
            ...
            <table class="table table-striped">
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&task=user.edit&id=' . (int)$item->id); ?>"
                        ...
                        <td class="center">
                            <?php if (substr_count($item->group_names, "\n") > 1) : ?>
                                <span class="hasTip"
                                      title="<?php echo JText::_('COM_USERS_HEADING_GROUPS') . '::' . nl2br($item->group_names); ?>"><?php echo JText::_('COM_USERS_USERS_MULTIPLE_GROUPS'); ?></span>
                            <?php else : ?>
