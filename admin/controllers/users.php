 ...
 */
class TZ_PinboardControllerUsers extends JControllerAdmin
{
    /**
     ...
     * @since    1.6
     */
    public function getModel($name = 'User', $prefix = 'TZ_PinboardModel', $config = array('ignore_request' => true))
    {
    ...
    public function changeBlock()
    {
        ...
        $this->setRedirect('index.php?option=com_tz_pinboard&view=users');
    }
