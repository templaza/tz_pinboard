                    ...
                    <div class="tz_pin_following_warp_user">
                        <div class="tz_pin_following_left">
                            <?php if(isset($followers->thongtin->tzimages) && !empty($followers->thongtin->tzimages)){  ?>
                                <img class="tz_pin_following_left_img"  src="<?php echo JUri::root().'/'.$followers->thongtin->tzimages;  ?>">
                            <?php }else{ ?>
                        ...
                        <div class="tz_pin_following_right">
                            <ul>
                                <li class="tz_pin_following_right_li1">
                                    <a href="<?php echo JRoute::_(TZ_PinboardHelperRoute::getPinboardManageruserRoute($followers->thongtin->uid)); ?>" rel="nofollow">
                                ...
                                <li class="tz_pin_following_right_li2">
                                    ...
                                    ?>
                                            <a class="tz_pin_following_button_a" href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=manageruser&task=tz.more.board&id_guest='.$followers->content[$i]->cid.'&id_board='. $followers->content[$i]->bordid); ?>" rel="nofollow">
