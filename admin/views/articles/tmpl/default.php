...
$canOrder = $user->authorise('core.edit.state', 'com_tz_pinboard.article');
$archived = $this->state->get('filter.published') == 2 ? true : false;
$trashed = $this->state->get('filter.published') == -2 ? true : false;
$saveOrder = $listOrder == 'a.ordering';
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tz_pinboard&task=articles.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=articles'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    <label for="filter_search"
                           class="element-invisible"><?php echo JText::_('COM_CONTENT_FILTER_SEARCH_DESC'); ?></label>
                    <input type="text" name="filter_search"
                           placeholder="<?php echo JText::_('COM_CONTENT_FILTER_SEARCH_DESC'); ?>" id="filter_search"
            ...
            <table class="table table-striped" id="articleList">
                ...
                <tr>
                    ...
                    <th width="10%">
                        <?php echo JHtml::_('grid.sort', 'Boads', 'category_title', $listDirn, $listOrder); ?>
                    </th>
                        ...
                        <td class="nowrap has-context">
                            <div class="pull-left">
                                ...
                                <?php if ($canEdit || $canEditOwn) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&task=article.edit&id=' . $item->id); ?>">
