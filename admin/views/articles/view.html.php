...
require_once(JPATH_COMPONENT_ADMINISTRATOR.'/helpers/tz_pinboard.php');
require_once(JPATH_COMPONENT_ADMINISTRATOR.'/helpers/html/category.php');
 ...
 */
class TZ_PinboardViewArticles extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        TZ_PinboardHelper::addSubmenu('articles');
	...
	{
		$canDo	= TZ_PinboardHelper::getActions($this->state->get('filter.category_id'));
...
//		}
	...
	//	JToolBarHelper::help('JHELP_CONTENT_ARTICLE_MANAGER');
        ...
        JHtmlSidebar::setAction('index.php?option=com_tz_pinboard&view=articles');
		...
		JHtmlSidebar::addFilter(
			JText::_('COM_TZ_PINBOARD_SELECT_BOARD'),
			'filter_category_id',
            JHtml::_('select.options', JHtml::_('category.options', 'com_tz_pinboard'), 'value', 'text', $this->state->get('filter.category_id'))
//			JHtml::_('select.options', $this->boars, 'value', 'text', $this->state->get('filter.category_id'))
		);
