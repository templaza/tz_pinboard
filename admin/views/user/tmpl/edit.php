            ...
            <div class="tab-pane active" id="details">
                <?php foreach($this->form->getFieldset('user_details') as $field) :?>
                    ...
                    <?php if($field -> fieldname == 'name'):?>
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <label title="<?php echo JText::_('COM_TZ_PINBOARD_USERS_IMGE_AVATAR');?>::<?php echo JText::_('COM_TZ_PINBOARD_USER_FIELD_GENDER_LABEL_DESC');?>"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <fieldset>
                                        ...
                                        <label for="delete_images"><?php echo JText::_('COM_TZ_PINBOARD_USERS_DELETE_IMAGES');?></label>
                                    </fieldset>
                                </div>
                            </div>
                        <?php endif;?>
                ...
                <?php endforeach; ?>
                <div class="control-group">
                    <div class="control-label"><label><?php echo JText::_('COM_TZ_PINBOARD_USER_TWITTER_LABEL');?></div>
                    <div class="controls"><input type="text" name="url_twitter" size="40"
                           value="<?php if($this -> listsUsers) echo $this -> listsUsers -> twitter?>"/>
                   </div>
                </div>
                <div class="control-group">
                    <div class="control-label"><label><?php echo JText::_('COM_TZ_PINBOARD_USERS_FACEBOOK_LABEL');?></label></div>
                    <div class="controls">
                ...
                <div class="control-group">
                    <div class="clr"></div>
                    <div class="control-lable"><label><?php echo JText::_('COM_TZ_PINBOARD_USERS_DESCRIPTION');?></label></div>
                    <div class="controls">
