            ...
            <li>
                     <?php if(isset($this->ShowCommnet[$i]->img_user) && !empty($this->ShowCommnet[$i]->img_user)){  ?>
                        ...
                        <p class="tz_detail_name_d">
                            <a class="tz_comment_name"  href="<?php echo JRoute::_(TZ_PinboardHelperRoute::getPinboardManageruserRoute($this->ShowCommnet[$i]->id_user)); ?>">
                                <?php
                            ...
                            <?php if($this->sosanhuser == $this->ShowCommnet[$i]->id_user || $this->sosanhuser == $this->ShowCommnet[$i]->create_by){ ?>
                                 <img class="tz_comment_delete" data-option-id="<?php echo $this->ShowCommnet[$i]->id_comment ?>" data-option-text="<?php echo $this->ShowCommnet[$i]->content_id_cm; ?>"  src="<?php echo JUri::root().'/components/com_tz_pinboard/images/delete3.png'?>" >
                            <?php } ?>
            </li>
