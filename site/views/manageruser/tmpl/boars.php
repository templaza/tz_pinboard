                ...
                <div class="tz_conten_board_class">
                    <div class="tz_board_class">
                        <h6 class="tz_conten_board_class_h5">
                            <a href="<?php echo JRoute::_(TZ_PinboardHelperRoute::getPinboardManagetuset2('',$rowname->created_user_id,$rowname->id_board)); ?>" rel="nofollow">
                    ...
                    <ul>
                        <li class="tz_conten_board_firs_2">
                            ...
                            ?>
                                <img id="tz_pin_more_warp_name_img" src="<?php echo JUri::root().'/'.$img_type_replaca ?>" alt="">
                            <?php
                            }
                            ?>
                        </li>
                        ...
                        ?>
                            <li class="tz_conten_board_firs_4">
                                ...
                                <a href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=manageruser&task=tz.edit&id_board='.$rowname->id_board);?>" rel="nofollow">
                    ...
                    <div id="tz_information_right">
                        ...
                        ?>
                                    <p id="tz_buttom_option">
                                        <a class="btn btn-small  btn-primary" href="<?php echo JURI::root() . "index.php/component/users/profile?layout=edit"; ?>">
    ...
    <div id="create_board">
        ...
        <div id="create_board_warp_form">
            <h5 id="create_board_warp_form_h5">
                ...
                <img id="create_board_warp_form_img" src="<?php echo JUri::root().'/components/com_tz_pinboard/images/delete_board.png' ?>"/>
            ...
            <form id="create_board_Form" action="" method="post">
                <div class="create_board_warp_form_name">
                    ...
                    <input type="text" id="board_name" name="boardname" maxlength="<?php echo $this->max_text_board; ?>" value="">
                    <p id="p_boardname"></p>
                </div>
                <div class="create_board_warp_form_name">
                    <label>
                    ...
                    <input type="text" id="aliasboard" name="aliasboard" maxlength="<?php echo $this->max_text_board; ?>" value="">
                ...
                <div class="create_board_text">
                    ...
                    <textarea name="decsipt" id="tz_board_textra" maxlength="<?php echo $this->max_text_board_ds; ?>"   style="width: 305px; height: 110px;" ></textarea>
                ...
                <input type="submit" id="subcreate" name="create" value="<?php echo JText::_('COM_TZ_PINBOARD_ADDPINBOARD_CREATE_A_BOARD') ?>">
