                ...
                <div id="j-main-container">
                    <div id="filter-bar" class="btn-toolbar">
                    			<div class="filter-search btn-group pull-left">
                    				<input type="text" name="filter_search" placeholder="<?php echo JText::_('COM_TZ_PINBOARD_SEARCH'); ?>" id="filter_search" value="<?php echo $this->search; ?>" title="<?php echo JText::_('COM_TZ_PINBOARD_SEARCH_TITLE'); ?>" />
                    			</div>
