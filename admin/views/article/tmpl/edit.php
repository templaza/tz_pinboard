...
<!--                                </div>-->
                            ...
                            <div class="control-group">
                                <div class="control-label">
                                    <label title="<?php echo JText::_('COM_TZ_PINBOARD_PINS_MEDIA_TYPE')?>::<?php echo JText::_('COM_TZ_PINBOARD_PINS_MEDIA_TYPE_DESCRIPT');?>"
...
<!--                            </div>-->
                            ...
                            <div class="control-group">
                                 ...
                                 <div class="controls">
                                     <input type="text"  disabled="false" value="<?php echo $this->item->web->url; ?>">
                                     <input type="hidden" name="url_Website"  value="<?php echo $this->item->web->url; ?>">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tz_content" data-toggle="tab"><?php echo JText::_('COM_TZ_PINBOARD_PINS_TAB_CONTENT');?></a></li>
<!--                    <li><a href="#tztabsImage" data-toggle="tab">--><?php //echo JText::_('COM_TZ_PINBOARD_TAB_IMAGE');?><!--</a></li>-->

<!--                    <li><a href="#tztabsGallery" data-toggle="tab">--><?php //echo JText::_('COM_TZ_PINBOARD_TAB_IMAGE_GALLERY');?><!--</a></li>-->
<!--                    <li><a href="#tztabsMedia" data-toggle="tab">--><?php //echo JText::_('COM_TZ_PINBOARD_TAB_MEDIA');?><!--</a></li>-->
<!--                    <li><a href="#tztabsFields" data-toggle="tab">--><?php //echo JText::_('COM_TZ_PINBOARD_TAB_FIELDS');?><!--</a></li>-->
<!--                    <li><a href="#tztabsAttachment" data-toggle="tab">--><?php //echo JText::_('COM_TZ_PINBOARD_TAB_ATTACHMENTS');?><!--</a></li>-->
                            ...
                            <div id="tz_images">
                                <div class="img_type">
                                    ...
                                    <select id="tz_select_img" name="tz_select_img">
                                            ...
                                            <option value="2" <?php if(isset($this->item->web->url)&&  !empty($this->item->web->url)){ ?> selected="true" <?php } ?>  >Website</option>
                                    </select>
                                </div>

                                <table class="admintable" id="tz_img_local" style="width: 100%;display:  <?php if(isset($this->item->web->url) ||  !empty($this->item->web->url)){ echo "none"; } ?> ">
                                    <tr>
                                ...
                                <table class="admintable"  id="tz_image_usrl" style="display:  <?php if(!isset($this->item->web->url) ||  empty($this->item->web->url)){ echo "none"; } ?>">
                                            <tr>
                                                <td align="left" id="tz_img_gallery">
                                                    <input type="text" class="inputbox image-select" name="imgurl" id="image-url" value="" style="width:283px;" />

                                                    <button type="button" id="buttom_url" name="buttom" value="Pins" style="width: 90px; border: 1px solid #c0c0c0; height: 30px">Pins Url</button>
                                    ...
                                    <tr>
                                        <td class="tz_img_slid">
                                            ...
                                            ?>
                                            <img style="max-width: 300px; cursor: pointer; margin-left: 116px; margin-top: 10px" src="<?php echo JURI::root().$img_type_replaca ?>">
                                            <input type="hidden" name="edit_img" value="<?php if(isset($list -> images)){echo $list -> images; }  ?>">
                                        </td>
                                    </tr>
