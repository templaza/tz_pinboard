                    ...
                    <div class="tz_button_pins">
                        ...
                        if ($Pins->id_user == $this->sosanhuser) {
                            ...
                            <a class="tz_button_repin"
                               href="<?php echo JText::_(TZ_PinboardHelperRoute::getPinboardManageruserRoute('', $Pins->content_id)); ?>"
                               rel="nofollow">
                                <span>
                        ...
                        <a data-option-id-img="<?php echo $Pins->content_id; ?>"
                           class="tz_button_repin tz_btn <?php if (empty($this->sosanhuser) || $this->sosanhuser == "0") {
