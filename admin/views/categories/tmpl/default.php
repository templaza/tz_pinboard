...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tz_pinboard&task=categories.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_tz_pinboard&view=categories'); ?>" method="post"
            ...
            <div id="filter-bar" class="btn-toolbar">
                ...
                <div class="btn-group hidden-phone">
                    ...
                    <button class="btn tip hasTooltip" type="button"
                            ...
                            data-original-title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>"><i
                    ...
                    <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent_id; ?>"
                        ...
                        <td>
                            ...
                            <?php if ($canEdit || $canEditOwn) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_tz_pinboard&task=category.edit&id=' . $item->id . '&extension=' . $extension); ?>">
