...
-------------------------------------------------------------------------*/
    ...
    $app    ->  addStyleSheet('components/com_tz_pinboard/css/tags.css');
...
//        }); // end hover
                ...
                if(data!="0"){
                    ...
                    jQuery('#tz_repin_title').focus(function(){
                        jQuery('#tz_repin_title').keyup(function(){
                            ...
                            var Text_r           = checkText(Text_value_input,Max_Text_input);
                            if(Text_r >0){
                                p_title.innerHTML = "<?php echo JText::_('COM_TZ_PINBOARD_ADDPINBOARD_PIN_WEBSITE_TITLE'); ?> "+Text_r;
                            }else{
        ...
        jQuery('#tz_comment').live("focus",function(){
            ...
            jQuery('#tz_comment').keyup(function(){
                ...
                if(Text >0){
                    p_title.innerHTML = "<?php echo JText::_('COM_TZ_PINBOARD_MANAGERUSER_COMMENT_LIMIT'); ?> "+Text;
                }else{
...
<div id="tz_pinboard_wrap">
    <div id="tz_pinboard_top">
        <span>
            <?php if(isset($this->NameTag->name) && !empty($this->NameTag->name)){  echo JText::_('COM_TZ_PINBOARD_TAGS') ?> <?php echo $this->NameTag->name; } ?>
        </span>
    </div>
    ...
    <?php }else{ ?>
        ...
        <div id="tz_load" style="display: none;">
            <a href="<?php echo JURI::root().'index.php?option=com_tz_pinboard&view=tags&task=add_ajax&id_tag='.$this->tags.'&page=2&Itemid='.JRequest::getInt('Itemid'); ?>">
            </a>
        </div>
...
<div id="tz_repin_more_warp" class="row-fluid">
    ...
    <div id="tz_repin_more_notice">
        <p><?php echo JText::_('COM_TZ_PINBOARD_ADDPINBOARD_NOTICE_REPIN'); ?></p>
    </div>
    <div id="tz_repin_more_notice_erro">
        <p><?php echo JText::_('COM_TZ_PINBOARD_ADDPINBOARD_NOTICE_REPIN_ERROR'); ?></p>
    </div>
