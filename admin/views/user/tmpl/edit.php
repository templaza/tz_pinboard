    ...
    <fieldset>
        <ul class="nav nav-tabs">
            <li class="active"><a href="#details"
                                  data-toggle="tab"><?php echo JText::_('COM_USERS_USER_ACCOUNT_DETAILS'); ?></a></li>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="details">
                    ...
                    <?php if ($field->fieldname == 'name'): ?>
                        <div class="control-group">
                            <div class="control-label">
                                <label><?php echo JText::_('COM_TZ_PINBOARD_USERS_YOUR_URL'); ?></label>
                            </div>
                            <div class="controls">
                                <input type="text"
                                       name="url"
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <label
                                    title="<?php echo JText::_('COM_TZ_PINBOARD_USERS_IMGE_AVATAR'); ?>::<?php echo JText::_('COM_TZ_PINBOARD_USER_FIELD_GENDER_LABEL_DESC'); ?>"
                    ...
                    <?php if ($this->listsUsers): ?>
                        <?php if ($field->fieldname == 'url_images' AND $this->listsUsers->images AND !empty($this->listsUsers->images)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <img src="<?php if ($this->listsUsers) echo $this->listsUsers->images; ?>"
                                         style="width:120px;">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <fieldset>
                                        ...
                                        <label
                                            for="delete_images"><?php echo JText::_('COM_TZ_PINBOARD_USERS_DELETE_IMAGES'); ?></label>
                                    </fieldset>
                                </div>
                            </div>
                        <?php endif; ?>
                ...
                <?php endforeach; ?>
                <div class="control-group">
                    <div class="control-label"><label><?php echo JText::_('COM_TZ_PINBOARD_USER_TWITTER_LABEL'); ?>
                    </div>
                ...
                <div class="control-group">
                    <div class="control-label">
                        <label><?php echo JText::_('COM_TZ_PINBOARD_USERS_FACEBOOK_LABEL'); ?></label></div>
                    <div class="controls">
                ...
                <div class="control-group">
                    <div class="control-label">
                        <label><?php echo JText::_('COM_TZ_PINBOARD_USERS_GOOGLE_LABEL'); ?></label>
                    </div>
                    <div class="controls">
                ...
                <div class="control-group">
                    ...
                    <div class="control-lable">
                        <label><?php echo JText::_('COM_TZ_PINBOARD_USERS_DESCRIPTION'); ?></label></div>
                    <div class="controls">
