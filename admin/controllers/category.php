 ...
 */
class TZ_PinboardControllerCategory extends JControllerForm
{
    /**
    ...
    public function batch($model = null)
    {
        ...
        // Preset the redirect
        $this->setRedirect('index.php?option=com_tz_pinboard&view=categories&extension=' . $this->extension);
    ...
    {
        $model = $this->getModel('Category', 'TZ_PinboardModel');
