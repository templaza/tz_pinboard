...
<form action="index.php?option=com_tz_pinboard&view=tags" method="post" name="adminForm" id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    ...
                    <input type="text" title="<?php echo JText::_('COM_TZ_PINBOARD_TAGS_SEARCH_DESC'); ?>"
                           value="<?php echo $this->state->filter_search; ?>"
                           placeholder="<?php echo JText::_('COM_TZ_PINBOARD_SEARCH_IN_NAME'); ?>"
                           id="filter_search"
                           name="filter_search"/>
                </div>
                <div class="btn-group pull-left">
                    <button type="submit" class="btn tip hasTooltip"
                            data-original-title="<?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?>"><i
                ...
                <div class="btn-group pull-right hidden-phone">
                    ...
                    <select name="directionTable" id="directionTable" class="input-medium"
                        ...
                        <option
                            value="asc" <?php if ($this->order_Dir == 'asc') echo 'selected="selected"'; ?>><?php echo JText::_('JGLOBAL_ORDER_ASCENDING'); ?></option>
                        <option
                            value="desc" <?php if ($this->order_Dir == 'desc') echo 'selected="selected"'; ?>><?php echo JText::_('JGLOBAL_ORDER_DESCENDING'); ?></option>
                    </select>
                </div>
            ...
            <table class="table table-striped" id="tagsList">
                ...
                <tr>
                    ...
                    <th class="title">
                        <?php echo JHtml::_('grid.sort', 'COM_TZ_PINBOARD_TAG_NAME', 'name', $this->order_Dir, $this->order); ?>
                    </th>
                    ...
                    <?php foreach ($this->lists as $i => $row): ?>
                        <tr class="<?php echo ($i % 2 == 0) ? 'row0' : 'row1'; ?>">
                            ...
                            <td class="nowrap has-context">
                                <div class="pull-left">
                                    <a href="index.php?option=com_tz_pinboard&amp;view=tags&amp;task=edit&amp;id=<?php echo $row->id; ?>">
                                        <?php echo $row->name; ?>
                                    </a>
                                </div>
                                <div class="pull-left">
                                    ...
                                    JHtml::_('dropdown.edit', $row->id, '', 'index.php?option=com_tz_pinboard&amp;view=tags');
