...
<img id="tz_repin_img_delete" src="<?php echo JUri::root()."/components/com_tz_pinboard/images/delete_board.png" ?>" alt="">
...
<form action="" method="post">
    <div class="tz_repin_more_warp_form_div">
        <select id="tz_repin_select" name="tz_repin_select">
            ...
            ?>
                    <option value="<?php echo $board_s->id; ?>" <?php  if($board_s->id == $this->repin->category_id){ ?> selected="true" <?php } ?>>
        ...
        <div class="tz_repin_more_warp_form_div">
            <textarea maxlength="<?php echo $this->max_introtext; ?>" id="tz_repin_introtext" style="width: 98%; height: 60px"><?php echo strip_tags($this->repin->content_introtext); ?></textarea>
            <p id="tz_repin_more_descript"></p>
        </div>
        <div class="tz_repin_more_warp_form_div">
            <input id="tz_repin_button" class="btn btn-large" type="button" name="repin_button" value="<?php echo JText::_('COM_TZ_PINBOARD_MANAGERUSER_REPIN'); ?>">
